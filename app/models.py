...
class Equipe(db.Model):
    ...
    colaboradores = db.relationship('Colaborador', back_populates='equipe', lazy='dynamic')
...
class Colaborador(UserMixin, db.Model):
    ...
    equipe = db.relationship('Equipe', back_populates='colaboradores')
    gestor = db.relationship('Colaborador', remote_side=[id], backref='subordinados')
    periodos_aquisitivos = db.relationship('PeriodoAquisitivo', back_populates='colaborador', lazy='dynamic')
